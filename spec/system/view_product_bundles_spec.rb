describe 'Visitor visit list of product bundles' do
  it 'and view all registered bundles' do
    ProductBundle.create!(name: 'Super Bundle',
                          sku_code: 'KSUMEBU25122021123456')
    ProductBundle.create!(name: 'Hiper Bundle',
                          sku_code: 'KHIMEBU25122021123456')
  ...
  it 'and view a specific product bundle' do
    ...
    ProductBundle.create!(name: 'Super Bundle',
                          sku_code: 'KSUMEBU25122021123456', product_models: [model1, model2])
